...
var CHOOSE_FROM_FLOWS_BUTTON_HELP_TEXT = "If you have any application deployed in SMART, then clicking on this button helps you try it.";
...
function popovercontrol(obj, context) {
    ...
    var stepShown = context.toStep;
    if (stepShown == 1) {
        $(".buttonNext").popover('show');
        $(".buttonFinish").popover('hide');
    } else if (stepShown == 2) {
        $("#go,.buttonNext").popover('show');
    } else if (stepShown == 3) {
        $("#newflow,.buttonNext").popover('show');
    } else if (stepShown == 4) {
        $("#tenant,#flow,.buttonNext").popover('show');
    } else if (stepShown == 5) {
        $("#objname,.buttonNext").popover('show');
    } else if (stepShown == 6) {
        $("#addfield,#templatepopover,.buttonNext").popover('show');
        $(".buttonFinish").popover('hide');
    } else if (stepShown == 7) {
        $(".buttonNext").popover('hide');
        $(".buttonFinish").popover('show');
    }
}
