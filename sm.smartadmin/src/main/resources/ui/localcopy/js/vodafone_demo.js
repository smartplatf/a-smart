...
function getLink(key){
    var url = "http://localhost:9081/"+ loader.tenant + "/UserProfileFlow/GenerateURL";
...
function generateLink(data) {
    ...
    $("#customlink").append("<a href='" + data.url + "' target='_blank'><button class='btn btn-medium btn-warning btn-block' style='background-color:#ea8511;'>"+ BUTTON_TEXT +" </button></a>");
}
