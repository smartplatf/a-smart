 ...
 * HEADERS
 * ************************************************************
 * File:                org.anon.smart.smcore.transition.parms.PrimeDataProbe
 * Author:              rsankar
 * Revision:            1.0
 * Date:                24-01-2013
 *
 ...
 * REVISIONS
 * ************************************************************
 * A probe that assigns prime data as a parameter
 *
 * ************************************************************
 * */
...
public class PrimeDataProbe extends AbstractProbe
{
    public PrimeDataProbe()
    {
        super();
    }
