 ...
 * HEADERS
 * ************************************************************
 * File:                org.anon.smart.smcore.config.modes.StaticValueMode
 * Author:              rsankar
 * Revision:            1.0
 * Date:                06-05-2013
 *
 ...
 * REVISIONS
 * ************************************************************
 * A mode where a static value is used to determine the configuration for this object
 *
 * ************************************************************
 * */
...
public class StaticValueMode extends AbstractMode
{
    public StaticValueMode()
    {
        super();
    }
        ...
        throws CtxException
    {
        if ((obj != null) && (obj instanceof SmartData))
        {
            ...
            Object conf = AnnotationUtils.configFor(data.getClass());
