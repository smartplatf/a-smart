 ...
 * HEADERS
 * ************************************************************
 * File:                org.anon.smart.codegen.factory.CodeGenFactory
 * Author:              arjun
 * Revision:            1.0
 * Date:                03-06-2013
 *
...
public class CodeGenFactory extends GeneratorFactory {
	...
	public Generator getGenerator(Type type) throws CtxException {
		...
		try {
			genProp.load(this.getClass().getClassLoader().getResourceAsStream("codegen.properties"));
		...
		try {
			genfac = (Generator) (Class.forName(genProp.getProperty(codeType)).newInstance());
