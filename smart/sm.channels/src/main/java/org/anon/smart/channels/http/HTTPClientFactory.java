 ...
 * HEADERS
 * ************************************************************
 * File:                org.anon.smart.channels.http.HTTPClientFactory
 * Author:              rsankar
 * Revision:            1.0
 * Date:                11-01-2013
 *
 ...
 * REVISIONS
 * ************************************************************
 * A factory to create a http client
 *
 * ************************************************************
 * */
...
import org.anon.smart.channels.http.netty.HTTPClient;

import org.anon.utilities.exception.CtxException;

public class HTTPClientFactory implements SCFactory
{
        ...
        throws CtxException
    {
        ...
        return new HTTPClient(shell, (HTTPConfig)cfg);
    }
}
